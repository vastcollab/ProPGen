...
# reads in mapping probability, reproprobs / fitnesses from command line args
...
def parse_arguments():
    ...
    parser.add_argument('--mapping_prob', type=float, default=None, help='Mapping probability override')
    parser.add_argument('--repro_prob', type=float, default=None, help='Repro probability override')
...
if __name__ == '__main__':
    ...
    if args.mapping_prob is not None:
        mapping_prob = args.mapping_prob

    if args.repro_prob is not None: # smaller of the two reproprobs
        repro_prob = args.repro_prob
